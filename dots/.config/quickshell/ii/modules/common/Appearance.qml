...
Singleton {
    ...
    // Controlled by bar settings: -1 = stronger hover, 1 = weaker hover.
    property real hoverOpacityOffset: Config.ready ? Config.options.bar.tooltips.hoverOpacityOffset : -1
    property real hoverTransparency: Math.max(0, Math.min(1, root.contentTransparency + Math.max(-1, Math.min(1, root.hoverOpacityOffset))))
    ...
    colors: QtObject {
        ...
        property color colLayer0Hover: ColorUtils.transparentize(ColorUtils.mix(colLayer0, colOnLayer0, 0.9, root.contentTransparency), root.hoverTransparency)
        ...
        property color colLayer1Hover: ColorUtils.transparentize(ColorUtils.mix(colLayer1, colOnLayer1, 0.92), root.hoverTransparency)
        ...
        property color colLayer2Hover: ColorUtils.solveOverlayColor(colLayer1Base, ColorUtils.mix(colLayer2Base, colOnLayer2, 0.90), 1 - root.hoverTransparency)
        ...
        property color colLayer3Hover: ColorUtils.solveOverlayColor(colLayer2Base, ColorUtils.mix(colLayer3Base, colOnLayer3, 0.90), 1 - root.hoverTransparency)
        ...
        property color colLayer4Hover: ColorUtils.solveOverlayColor(colLayer3Base, ColorUtils.mix(colLayer4Base, colOnLayer4, 0.90), 1 - root.hoverTransparency)
